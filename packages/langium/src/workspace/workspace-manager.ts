...
export class DefaultWorkspaceManager implements WorkspaceManager {
    ...
    protected fileExtensions = new Set<string>();
    ...
    constructor(services: LangiumSharedCoreServices) {
        ...
        this.fileExtensions = new Set(this.serviceRegistry.all.flatMap(e => e.LanguageMetaData.fileExtensions));
    }
    ...
    includeEntry(entry: FileSystemNode): boolean {
        ...
        if (entry.isDirectory) {
            ...
            return this.fileExtensions.has(extname);
        }
        return false;
    }
